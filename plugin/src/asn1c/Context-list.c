...
static asn_SET_OF_specifics_t asn_SPC_transfer_syntax_name_list_specs_5 = {
	sizeof(struct transfer_syntax_name_list),
	offsetof(struct transfer_syntax_name_list, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_Context_list_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_Member_2,
...
static asn_SET_OF_specifics_t asn_SPC_Context_list_specs_1 = {
